        ...
        <div class="col-md-4 mx-auto">
          <div class="image-wrapper pb-3">
            ...
            <div class="row">
              ...
              <div class="col-md-8">
                <div class="form-group">
                  <input type="text" class="form-control" id="userpass" name="password" maxlength="4" pattern="([1-4]+0[0-4]*|[0-4]*0[1-4]+)+" title="4 digits, 1 zero, digits 1-4 only" placeholder="Enter PassNumber" autocomplete="off" required/>
              ...
              <div class="col-md-5">
                <div class="form-group">
                  <input type="submit" id="submit-button" name="submit" class="btn btn-success mt-3" value="Change Passnumber" />
                </div>
              </div>
              <div class="col-md-7">
                <div class="form-group">
