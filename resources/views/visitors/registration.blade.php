      ...
      <div class="row mt-5">
        ...
        <div class="col-md-6 pl-5">
          <div class="image-holder pb-3 pl-5">
            ...
            <form id="myForm" action="{{ url('/signup') }}" class="mt-3" method="post">
            {{ csrf_field() }}
              <table>
                  <tr>
                    <td>
                    ...
                    <td>
                      <input type="text" class="form-control" id="username" name="username" maxlength="30" placeholder="username"/>
                    </td>
                </tr>
                <tr>
                  <td colspan="2">
                ...
                <tr>
                    ...
                    <td>
                      <input type="text" class="form-control" id="usermail" name="usermail" maxlength="30" placeholder="Email"/>
                    </td>
                </tr>
                <tr>
                  <td colspan="2">
                ...
                <tr>
                  ...
                  <td>
                    <input type="text" class="form-control" id="userpass" name="password" maxlength="4" pattern="[1-4]*0[1-4]*" title="4 digits, 1 zero, digits 1-4 only" placeholder="4 digits, 1 zero, digits 1-4 only" autocomplete="off"/>
                  </td> 
                </tr>
                <tr>
                  <td colspan="2">
                ...
                <tr>	
                  <td colspan="2"> 
                    <input type="submit" id="submit-button" name="submit" class="btn btn-success mt-3" value="Create user" disabled />
                ...
                <td colspan="2"> 
                <h2> Please confirm your email before login. </h2>
                @endif
                <tr>	
                  <td colspan="2"> 
