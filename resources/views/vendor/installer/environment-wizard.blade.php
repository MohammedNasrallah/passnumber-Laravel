    ...
    <div class="tabs tabs-full">
        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <!-- PassNum Customization -->
                <div class="form-group {{ $errors->has('google_key') ? ' has-error ' : '' }}">
                    <label for="google_key">
                        {{ trans('installer_messages.environment.wizard.form.google_key_label') }}
                    </label>
                    <input type="text" name="google_key" id="google_key" value="" placeholder="{{ trans('installer_messages.environment.wizard.form.google_key_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('google_secret') ? ' has-error ' : '' }}">
                    <label for="google_secret">
                        {{ trans('installer_messages.environment.wizard.form.google_secret_label') }}
                    </label>
                    <input type="text" name="google_secret" id="google_secret" value="" placeholder="{{ trans('installer_messages.environment.wizard.form.google_secret_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('reset_mail') ? ' has-error ' : '' }}">
                    <label for="reset_mail">
                        {{ trans('installer_messages.environment.wizard.form.reset_mail_label') }}
                    </label>
                    <input type="text" name="reset_mail" id="reset_mail" value="" placeholder="{{ trans('installer_messages.environment.wizard.form.reset_mail_placeholder') }}" />
                    @if ($errors->has('reset_mail'))
                        <span class="error-block">
                            <i class="fa fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
                            {{ $errors->first('reset_mail') }}
                        </span>
                    @endif
                </div>
                <div class="form-group {{ $errors->has('confirm_mail') ? ' has-error ' : '' }}">
                    <label for="confirm_mail">
                        {{ trans('installer_messages.environment.wizard.form.confirm_mail_label') }}
                    </label>
                    <input type="text" name="confirm_mail" id="confirm_mail" value="" placeholder="{{ trans('installer_messages.environment.wizard.form.confirm_mail_placeholder') }}" />
                    @if ($errors->has('confirm_mail'))
                        <span class="error-block">
                            <i class="fa fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
                            {{ $errors->first('confirm_mail') }}
                        </span>
                    @endif
                </div>
                <div class="form-group {{ $errors->has('min_attempt') ? ' has-error ' : '' }}">
                    <label for="min_attempt">
                        {{ trans('installer_messages.environment.wizard.form.min_attempt_label') }}
                    </label>
                    <input type="text" name="min_attempt" id="min_attempt" value="" placeholder="{{ trans('installer_messages.environment.wizard.form.min_attempt_placeholder') }}" />
                    @if ($errors->has('min_attempt'))
                        <span class="error-block">
                            <i class="fa fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
                            {{ $errors->first('min_attempt') }}
                        </span>
                    @endif
                </div>
                <div class="form-group {{ $errors->has('max_attempt') ? ' has-error ' : '' }}">
                    <label for="max_attempt">
                        {{ trans('installer_messages.environment.wizard.form.max_attempt_label') }}
                    </label>
                    <input type="text" name="max_attempt" id="max_attempt" value="" placeholder="{{ trans('installer_messages.environment.wizard.form.max_attempt_placeholder') }}" />
                    @if ($errors->has('max_attempt'))
                        <span class="error-block">
                            <i class="fa fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
                            {{ $errors->first('max_attempt') }}
                        </span>
                    @endif
                </div>
                <!-- PassNum Customization -->
